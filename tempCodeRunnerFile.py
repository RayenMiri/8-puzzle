...
class PuzzleGame:
    ...
    def start_game(self, p):
        ...
        reset_button = tk.Button(control_frame, background='#1E1E1E', foreground='#FFFFFF', activebackground='#2C2C2C',
                                 activeforeground='#FFFFFF', text="Restart", width=10, height=1, font=button_font, bd=0,
                                 command=self.reset_game)
        reset_button.grid(row=0, column=0, padx=10)
        solve_button = tk.Button(control_frame, background='#1E1E1E', foreground='#FFFFFF', activebackground='#2C2C2C',
                                 activeforeground='#FFFFFF', text="Solve", width=10, height=1, font=button_font, bd=0,
